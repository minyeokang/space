        ...
        <div className={styles.mypage}>
            ...
            <div className={styles.flex}>
                ...
                <div >
                    ...
                    <span>매월 24,000원</span> <span>1년 240,000원</span><span>2년 340,000원</span>
                </div>
            ...
            <div className={styles.checkout}>
                ...
                <div className={styles.fav}>
                    ...
                    <div className={styles.devide}>
                        {
                            props.newsClicked === true ?
                                <div >
                                    <img src={props.news[props.nums].img} alt="news" />
                                    <div>
                                        <h3>{props.news[props.nums].title}</h3>
                                    </div>
                                </div>
                                : null
                        }
